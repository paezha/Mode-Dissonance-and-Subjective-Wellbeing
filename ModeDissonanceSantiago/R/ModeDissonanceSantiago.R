...
#'
#' The ModeDissonanceSantiago is a companion package for **paper**. The package includes
#'   the data used in the analysis of mode dissonance in Santiago, Chile; it also includes
#'   one utility function for cross-tabulations.
#'
