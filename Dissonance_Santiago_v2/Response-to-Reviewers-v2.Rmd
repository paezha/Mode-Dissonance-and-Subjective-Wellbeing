...
>\textcolor{blue}{The consideration of factors related to the subjective personal well-being will enable targeting public policy strategies focused on nudging public and active transport users}
...
>\textcolor{blue}{Recent social demands have highlighted the relevance and impacts of the neoliberal economic model in the development of the city – which correlates with the construction of the society and therefore shapes the development of transport infrastructure (see for recent protests and social crisis: Davies, 2019; Guardiola-Rivera, 2019; Sehnbruch, 2019). Even though everyday mobility in Santiago has also been contextualized in relation to other Latin American cities (Avellaneda and Lazo, 2011; Rodriguez Vignoli, 2008), there is much more to be explored in other regions in the Chilean context. Measuring instruments and new methodologies have allowed a more accurate and precise understanding of the social issues arising as consequence of transport infrastructure and housing provision (Cox and Hurtubia, 2016), and the minimum provision of basic services (Tiznado-Aitken et al., 2016). However, the focus on accessibility as a measure of inequities remains predominant (Tiznado-Aitken et al., 2018; Figueroa Martínez, et al., 2018; Niehaus et al., 2016; Rojas et al., 2016).}
...
>\textcolor{blue}{The study considers data from 3 out of 8 sections of a longer survey – data being more relevant for the study. The topics around these sections are Individual characteristics of respondents, feelings and emotions related to their commute, and aspects describing their regular commute trips.}
...
>\textcolor{blue}{The sample tends to be younger (56% is younger than 34 years old), and well-educated (68% of respondents having technical or professional education), with an almost uniform distribution of income levels. The trend in typical commute time is towards longer commutes – e.g. 55% of the trips are longer than 40 minutes, and from those 56% corresponds to trips over the 60 minutes long.}

St Louis et al 2014: L157 Explain why ‘more research is needed’

>\textcolor{blue}{Because most literature focuses in trip satisfaction – the study goes beyond the understanding of determinants of trip satisfaction.}
...
>\textcolor{blue}{Understanding who experiences dissonance is relevant in this study. We believe most disadvantageous groups will experience more dissonance with respect to their primary travel mode and affective values, namely freedom, enjoyment, happiness, feelings of poverty, luxury, and status.}
...
>\textcolor{blue}{As noted in our response to Reviewer 1, recent social demands have highlighted the relevance and impacts of the neoliberal economic model in the development of the city – which correlates with the construction of the society and therefore shapes the development of transport infrastructure (see for recent protests and social crisis: Davies, 2019; Guardiola-Rivera, 2019; Sehnbruch, 2019). Even though everyday mobility in Santiago has also been contextualized in relation to other Latin American cities (Avellaneda and Lazo, 2011; Rodriguez Vignoli, 2008), there is much more to be explored in other regions in the Chilean context. Measuring instruments and new methodologies have allowed a more accurate and precise understanding of the social issues arising as consequence of transport infrastructure and housing provision (Cox and Hurtubia, 2016), and the minimum provision of basic services (Tiznado-Aitken et al., 2016). However, the focus on accessibility as a measure of inequities remains predominant (Tiznado-Aitken et al., 2018; Figueroa Martínez, et al., 2018; Niehaus et al., 2016; Rojas et al., 2016).}
...
>\textcolor{blue}{This has been discussed in section 3.2. paragraph 4.}
...
>\textcolor{blue}{This has been also commented in the Background section: “The research needs already recognized in the developed world are also markedly acute in the context of the Global South, where historical inequality has tended to create a symbolic attachment to the automobile, in addition to negative connotations for public transport and active travel”. A separated paragraph in the conclusion addresses this discussion, in the Chilean and LA context.}

Method: The data collection procedure is not described.

>\textcolor{blue}{The data collection considered a quota-sampling method for gathering the information, considering the socio-demographic information from Pre-Census of 2012. The survey was carried out face-to-face in centres of activity with dense provision of offices, services and educational centres.}
...
SWB and health: The author(s) could at least add a paragraph about how SWB affects health, except for just mentioning that SWB has been found to be correlated with health.
